export default {
    OFFLINEMESSAGE: 'Pedimos desculpas. Estamos offline no momento. Nos envie uma mensagem e responderemos o mais rápido possível.',
    ONLINEMESSAGE: 'Estamos online novamente.',
